...
public class ErrorGenerator {
    ...
    //Change one bit of the tram to introduce and error which should be detected with the CRC
     public String bitWiseError(String tram){
    ...
    public String burstError(String tram, int burstLenght){
    ...
    public void delayTram() throws InterruptedException {
    ...
    public boolean errorDecider(int probabilityThreshold){

         if( Math.random() * 10 < probabilityThreshold){
             return true;
         }
